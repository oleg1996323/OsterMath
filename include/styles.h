...
public:
    DarkStyle(){
        ...
        setBrush(QPalette::ColorRole::Text,QBrush(QColor(250,250,250),Qt::BrushStyle::SolidPattern));
        setBrush(QPalette::ColorRole::PlaceholderText,QBrush(QColor(250,250,250),Qt::BrushStyle::SolidPattern));
